...
export function buildSystemPrompt(): string {
  return [
    ...
    "Notion: use notion_search_tasks / notion_create_task / notion_update_task for your tasks DB (set NOTION_TASKS_DB_ID). If project tools are available, they map to a separate projects database.",
